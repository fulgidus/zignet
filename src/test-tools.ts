...
console.log("\n--- analyze_zig result ---");
const analyzeResult1 = analyzeZig({ code: validCode });
console.log(formatAnalyzeResult(analyzeResult1));

console.log("\n--- compile_zig result ---");
const compileResult1 = compileZig({ code: validCode });
...
console.log("Input:");
console.log(syntaxErrorCode);
console.log("\n--- analyze_zig result ---");
const analyzeResult2 = analyzeZig({ code: syntaxErrorCode });
...
console.log("Input:");
console.log(typeErrorCode);
console.log("\n--- analyze_zig result ---");
const analyzeResult3 = analyzeZig({ code: typeErrorCode });
...
console.log("\n--- analyze_zig result ---");
const analyzeResult4 = analyzeZig({ code: emptyCode });
...
console.log("\n--- compile_zig result ---");
const compileResult5 = compileZig({ code: complexCode });
