...
### � Fixed
https://github.com/fulgidus/zignet/issues/5
...
### Features
- **Added** `mcp-server.ts` to provide a command-line status updates when starting the MCP server about the model download.
